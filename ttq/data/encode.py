...
import ttq.utils.example as example_utils
...
def _thread_encode_images(thread_index, encoder, images, labels, image_ranges, name, directory):
        ...
        with tf.python_io.TFRecordWriter(filename) as writer:
            for image_index in xrange(*image_range):
                ...
                example = tf.train.Example(features=tf.train.Features(feature={
                    ...
                    'image/class/label': example_utils.int64_feature(label),
                }))
...
def encode_images(encoder, images, labels, name, directory, images_per_file=10000, num_threads=1):
    ...
    for thread_index in xrange(len(image_ranges)):
        thread_args = (thread_index, encoder, images, labels, image_ranges, name, directory)
